...
public class Menu20_error extends Activity implements OnTouchListener {
...
//	   float zoom = 0.5f;
	   ...
	   public void onCreate(Bundle savedInstanceState) {
	      ...
	      try {
	      setContentView(R.layout.menu20_error);
...
//		   	BitmapDrawable d = (BitmapDrawable) mContext.getResources().getDrawable(R.drawable.p1);
		    ...
		    view = (ImageView) findViewById(R.id.imageView20error);
