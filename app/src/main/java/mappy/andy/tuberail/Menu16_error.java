...
public class Menu16_error extends Activity implements OnTouchListener {
...
//	   float zoom = 0.5f;
	   ...
	   public void onCreate(Bundle savedInstanceState) {
	      ...
	      try {
	      setContentView(R.layout.menu16_error);
...
//		   	BitmapDrawable d = (BitmapDrawable) mContext.getResources().getDrawable(R.drawable.p1);
		    ...
		    view = (ImageView) findViewById(R.id.imageView16error);
