...
public class GeneralErrorMessage extends Activity implements OnTouchListener {
...
//	   float zoom = 0.5f;
	   ...
	   public void onCreate(Bundle savedInstanceState) {
	      ...
	      try {
	      setContentView(R.layout.generalerrormessage);
...
//		   	BitmapDrawable d = (BitmapDrawable) mContext.getResources().getDrawable(R.drawable.p1);
		    ...
		    view = (ImageView) findViewById(R.id.generalerrormessage);
...
//// matrix.postTranslate(-1100.0f, -600.0f);
	    ...
	    // close on two errors!	startActivity(new Intent(this, Menu10_error.class )); // dummy error pic
	    	finish();
